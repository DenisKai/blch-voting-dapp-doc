...
\hl{rephrasen hier mit lehrverantsaltung}
...
die Transaktionen signiert. \hl{rephrasen hier mit merkblatt} Im Merkblatt werden beispielhaft Web3.js und MetaMask
...
\hl{ich weiss nicht ob es da hier braucht ggf bis auf admin adresse, weil das ja quasi die natur der DApp ist welche ihren state on chain verwaltet}
...
\hl{hier rephrasen für den alltag im kurs}
...
Chain passen, gegen die MetaMask verbunden ist. Ein häufiger Fehler im \hl{das ist hier irrelvant mit im praktikum} Praktikum
